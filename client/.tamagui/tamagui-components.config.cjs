...
var require_Adapt = __commonJS({
  "node_modules/@tamagui/adapt/dist/cjs/Adapt.js"(exports, module2) {
    ...
    var Adapt2 = (0, import_core31.withStaticProperties)(
      /* @__PURE__ */ __name(function Adapt22({ platform: platform3, when, children }) {
        const context = (0, import_react13.useContext)(AdaptParentContext);
        let enabled = !platform3;
        if (platform3 === "touch")
          enabled = import_core31.isTouchable;
        if (platform3 === "native")
          enabled = !import_core31.isWeb;
        if (platform3 === "web")
          enabled = import_core31.isWeb;
...
var require_AnimatePresence = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      let forceRender = (0, import_core31.useForceUpdate)();
      const isClientMounted = (0, import_core31.useDidFinishSSR)();
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "div",
          {
            ...
            onFocusCapture: (0, import_core31.composeEventHandlers)(
              // @ts-ignore
              props.onFocusCapture,
              focusOutside.onFocusCapture
            ),
            onBlurCapture: (0, import_core31.composeEventHandlers)(
              // @ts-ignore
              props.onBlurCapture,
              focusOutside.onBlurCapture
            ),
            onPointerDownCapture: (0, import_core31.composeEventHandlers)(
              // @ts-ignore
...
var require_Stacks = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/Stacks.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      ...
      const sizeNum = (0, import_core31.isVariable)(token) ? +token.val : size2;
    ...
    var YStack2 = (0, import_core31.styled)(import_core31.Stack, {
      flexDirection: "column",
      name: "YStack",
      variants: variants2
    });
    var XStack2 = (0, import_core31.styled)(import_core31.Stack, {
      flexDirection: "row",
      name: "XStack",
      variants: variants2
    });
    var ZStack2 = (0, import_core31.styled)(
      YStack2,
      {
        name: "ZStack",
        position: "relative"
    ...
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core31.getVariableValue)(tokens.size["true"]);
...
var require_cjs10 = __commonJS({
  "node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown2 = /* @__PURE__ */ __name((type, name = "$true", shift2 = 0, bounds = [0]) => {
      const tokens = (0, import_core31.getTokens)({ prefixed: true })[type];
      const keysOrdered = import_core31.tokensKeysOrdered.get(tokens) || Object.keys(tokens);
      const min4 = bounds[0] ?? 0;
      const max4 = bounds[1] ?? keysOrdered.length - 1;
      const currentIndex = keysOrdered.indexOf(name);
      if (name === "$true") {
        shift2 += shift2 === 0 ? 0 : shift2 > 0 ? 1 : -1;
      }
      const index4 = Math.min(max4, Math.max(min4, currentIndex + shift2));
...
var require_SizableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/SizableStack.js"(exports, module2) {
    ...
    var SizableStack2 = (0, import_core31.styled)(import_Stacks4.YStack, {
      name: "SizableStack",
...
var require_ThemeableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/ThemeableStack.js"(exports, module2) {
    ...
    var ThemeableStack2 = (0, import_core31.styled)(import_Stacks4.YStack, {
      name: "SizableStack",
      variants: {
        backgrounded: {
          true: {
    ...
    var Portal = /* @__PURE__ */ __name(({ host = ((_a) => (_a = globalThis.document) == null ? void 0 : _a.body)(), ...props }) => {
      const contents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        import_stacks9.YStack,
        {
          contain: "strict",
          fullscreen: true,
          position: import_core31.isWeb ? "fixed" : "absolute",
          maxWidth: import_core31.isWeb ? "100vw" : "100%",
          maxHeight: import_core31.isWeb ? "100vh" : "100%",
          pointerEvents: "none",
          ...props
        }
      );
...
var require_GorhomPortal = __commonJS({
  "node_modules/@tamagui/portal/dist/cjs/GorhomPortal.js"(exports, module2) {
    ...
    var PortalHostComponent = /* @__PURE__ */ __name((props) => {
      ...
      const isServer2 = !(0, import_core31.useDidFinishSSR)();
    ...
    var PortalComponent = /* @__PURE__ */ __name((props) => {
      ...
      const handleOnMount = (0, import_core31.useEvent)(() => {
      ...
      const handleOnUnmount = (0, import_core31.useEvent)(() => {
      ...
      const handleOnUpdate = (0, import_core31.useEvent)(() => {
...
var require_ScrollView = __commonJS({
  "node_modules/@tamagui/scroll-view/dist/cjs/ScrollView.js"(exports, module2) {
    ...
    var ScrollView2 = (0, import_core31.styled)(
    ...
    var SheetScrollView = (0, import_react13.forwardRef)(
      ({ __scopeSheet, children, ...props }, ref) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          ...
          {
            ref: (0, import_core31.composeRefs)(scrollRef, ref),
            flex: 1,
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Stack, { height: percentToPadBottom / 100 * frameSize, width: 0 })
            ]
          }
        );
      }
...
var require_Sheet = __commonJS({
  "node_modules/@tamagui/sheet/dist/cjs/Sheet.js"(exports, module2) {
    ...
    var SheetHandleFrame = (0, import_core31.styled)(import_stacks9.XStack, {
    ...
    var SheetHandle = SheetHandleFrame.extractable(
      ({ __scopeSheet, ...props }) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          ...
          {
            onPress: () => {
              const max4 = context.snapPoints.length + (context.dismissOnSnapToBottom ? -1 : 0);
              const nextPos = (context.position + 1) % max4;
    ...
    var SheetOverlayFrame = (0, import_core31.styled)(import_stacks9.YStack, {
      ...
      ({ __scopeSheet, ...props }) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          SheetOverlayFrame,
          {
            ...
            ...props,
            onPress: (0, import_core31.mergeEvent)(
              props.onPress,
    ...
    var selectionStyleSheet = import_core31.isClient ? document.createElement("style") : null;
    if (selectionStyleSheet) {
      document.head.appendChild(selectionStyleSheet);
    }
    var SheetFrameFrame = (0, import_core31.styled)(import_stacks9.YStack, {
    ...
    var Sheet = (0, import_core31.withStaticProperties)(
      (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function Sheet2(props, ref) {
        const hydrated = (0, import_core31.useDidFinishSSR)();
    ...
    var SheetImplementation = (0, import_core31.themeable)(
      (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, ref) {
        ...
        const driver = (0, import_core31.getAnimationDriver)();
        if (!driver) {
          throw new Error("Must set animations in tamagui.config.ts");
        }
        const disableDrag = disableDragProp ?? (controller == null ? void 0 : controller.disableDrag);
        const themeName = (0, import_core31.useThemeName)();
        ...
        const animateTo = (0, import_core31.useEvent)((position2) => {
        ...
        const shouldHideParentSheet = !import_core31.isWeb && modal && isShowingInnerSheet;
        ...
        const handleLayout = (0, import_react13.useCallback)((e) => {
          ...
          if (import_core31.isWeb && import_core31.isTouchable && !open) {
            next += 100;
          }
          if (!next)
            return;
        ...
        if (modal) {
          const modalContents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_portal3.Portal, { zIndex, ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_adapt2.AdaptParentContext.Provider, { value: adaptContext, children: contents }) }) });
    ...
    var SheetController2 = /* @__PURE__ */ __name(({
      ...
      const onOpenChange = (0, import_core31.useEvent)(onOpenChangeProp);
...
var require_cjs19 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    var getFontSized4 = /* @__PURE__ */ __name((sizeTokenIn = "$true", { fonts, props }) => {
      var _a, _b, _c;
      const family = (0, import_core31.getVariableValue)(props.fontFamily) || "$body";
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core31.getTokens)().size;
...
var require_SizableText = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/SizableText.js"(exports, module2) {
    ...
    var SizableText2 = (0, import_core31.styled)(import_core31.Text, {
      name: "SizableText",
      fontFamily: "$body",
      variants: {
...
var require_Paragraph = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/Paragraph.js"(exports, module2) {
    ...
    var Paragraph2 = (0, import_core31.styled)(import_SizableText2.SizableText, {
      name: "Paragraph",
      tag: "p",
      userSelect: "auto",
      color: "$color",
...
var require_Headings = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/Headings.js"(exports, module2) {
    ...
    var Heading2 = (0, import_core31.styled)(import_Paragraph2.Paragraph, {
      tag: "span",
      name: "Heading",
    ...
    var H12 = (0, import_core31.styled)(Heading2, {
      name: "H1",
      tag: "h1",
      size: "$10"
    });
    var H22 = (0, import_core31.styled)(Heading2, {
      name: "H2",
      tag: "h2",
      size: "$9"
    });
    var H32 = (0, import_core31.styled)(Heading2, {
      name: "H3",
      tag: "h3",
      size: "$8"
    });
    var H42 = (0, import_core31.styled)(Heading2, {
      name: "H4",
      tag: "h4",
      size: "$7"
    });
    var H52 = (0, import_core31.styled)(Heading2, {
      name: "H5",
      tag: "h5",
      size: "$6"
    });
    var H62 = (0, import_core31.styled)(Heading2, {
      name: "H6",
      tag: "h6",
      size: "$5"
    });
...
var require_Dialog = __commonJS({
  "node_modules/@tamagui/dialog/dist/cjs/Dialog.js"(exports, module2) {
    ...
    var DialogTriggerFrame2 = (0, import_core31.styled)(import_stacks9.YStack, {
      name: TRIGGER_NAME2
    });
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          DialogTriggerFrame2,
          {
            ...
            onPress: (0, import_core31.composeEventHandlers)(props.onPress, context.onOpenToggle)
          }
        );
      }
    );
    ...
    var DialogPortalFrame2 = (0, import_core31.styled)(import_stacks9.YStack, {
      alignItems: "center",
    ...
    function DialogPortalItemContent2(props) {
      ...
      if (space || separator) {
        childrenSpaced = (0, import_core31.spacedChildren)({
          children,
          separator,
          space,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogProvider2, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Theme, { name: themeName, children: childrenSpaced }) });
    }
    ...
    var DialogOverlayFrame2 = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: OVERLAY_NAME2,
      backgrounded: true,
      fullscreen: true
    });
    ...
    var DialogContentFrame2 = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: CONTENT_NAME2,
      tag: "dialog",
      position: "relative",
      backgrounded: true,
      ...
      ({ children, context, ...props }, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          DialogContentImpl2,
          {
            ...
            onCloseAutoFocus: (0, import_core31.composeEventHandlers)(props.onCloseAutoFocus, (event) => {
              var _a;
              event.preventDefault();
              (_a = context.triggerRef.current) == null ? void 0 : _a.focus();
            }),
            onPointerDownOutside: (0, import_core31.composeEventHandlers)(
            ...
            onFocusOutside: (0, import_core31.composeEventHandlers)(
    ...
    var DialogTitleFrame2 = (0, import_core31.styled)(import_text5.H2, {
      name: TITLE_NAME2
    });
    ...
    var DialogDescriptionFrame2 = (0, import_core31.styled)(import_text5.Paragraph, {
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          import_stacks9.YStack,
          {
            ...
            ...closeProps,
            ref: forwardedRef,
            onPress: (0, import_core31.composeEventHandlers)(
              props.onPress,
...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
    ...
    var Dialog3 = (0, import_core31.withStaticProperties)(
      React14.forwardRef(/* @__PURE__ */ __name(function Dialog22(props, ref) {
        ...
        const scopeId = (0, import_core31.useId)();
        const contentId = (0, import_core31.useId)();
        const titleId = (0, import_core31.useId)();
        const descriptionId = (0, import_core31.useId)();
    ...
    var DialogSheetController2 = /* @__PURE__ */ __name((props) => {
      ...
      const getShowSheet = (0, import_core31.useGet)(showSheet);
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    ...
    var useSheetBreakpointActive2 = /* @__PURE__ */ __name((context) => {
      const media = (0, import_core31.useMedia)();
...
var require_AlertDialog = __commonJS({
  "node_modules/@tamagui/alert-dialog/dist/cjs/AlertDialog.js"(exports, module2) {
    ...
    var NativeAlertDialogTriggerFrame = (0, import_core31.styled)(import_stacks9.YStack, {
      name: "DialogTrigger"
    });
      ...
      (props, forwardedRef) => {
        if (props["__native"]) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            ...
            {
              ...rest,
              onPress: (0, import_core31.composeEventHandlers)(onPress, __onPress)
            }
          );
        }
          ...
          import_dialog.DialogWarningProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
              import_dialog.DialogContent,
              {
                ...
                ...contentProps,
                ref: composedRefs,
                onOpenAutoFocus: (0, import_core31.composeEventHandlers)(
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Slottable, { children }),
      ...
      if (process.env.TAMAGUI_TARGET === "native") {
        ...
        forEachChildDeep(React14.Children.toArray(props.children), (child) => {
          if (!React14.isValidElement(child))
            return false;
          const name = (0, import_core31.isTamaguiElement)(child) ? child.type.staticConfig.componentName : child.type["displayName"];
          switch (name) {
            case TRIGGER_NAME2: {
    ...
    var AlertDialog = (0, import_core31.withStaticProperties)(AlertDialogInner, {
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var import_core31 = require("@tamagui/core-node");
    var import_react_native6 = require("react-native-web-lite");
    (0, import_core31.setupReactNative)({
      Image: import_react_native6.Image
    });
    var StyledImage = (0, import_core31.styled)(import_react_native6.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" },
      zIndex: 1
    ...
    var Image2 = StyledImage.extractable((inProps) => {
      const props = (0, import_core31.useMediaPropsActive)(inProps);
      const { src, ...rest } = props;
      const source = typeof src === "string" ? { uri: src, ...import_core31.isWeb && { width: props.width, height: props.height } } : src;
...
var require_Square = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/Square.js"(exports, module2) {
    ...
    var Square2 = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: "Square",
      alignItems: "center",
      justifyContent: "center",
      variants: {
...
var require_Circle = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/Circle.js"(exports, module2) {
    ...
    var Circle = (0, import_core31.styled)(import_Square.Square, {
      name: "Circle",
      circular: true
    });
  }
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize2 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      if ((0, import_core31.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core31.getConfig)();
...
var require_getSpace = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core31.getTokens)().space;
...
var require_useCurrentColor = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      const theme = (0, import_core31.useTheme)();
      return (0, import_core31.variableToString)(theme[colorProp] || colorProp || theme.color);
    }, "useCurrentColor");
  }
});
  ...
  "node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function focusableInputHOC3(Component) {
      const component = Component.extractable(
        (0, import_react13.forwardRef)(
          (props, ref) => {
            const isInput = (0, import_core31.isTamaguiComponent)(Component) && Component.staticConfig.isInput;
            ...
            const onChangeText = (0, import_core31.useEvent)((value) => {
              var _a;
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_react13 = require("react");
    var NAME3 = "ListItem";
    var ListItemFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: NAME3,
      tag: "li",
      alignItems: "center",
      flexWrap: "nowrap",
    ...
    var ListItemText = (0, import_core31.styled)(import_text5.SizableText, {
      name: "ListItemText",
      color: "$color",
      userSelect: "none",
      flexGrow: 1,
    ...
    var ListItemSubtitle = (0, import_core31.styled)(ListItemText, {
    ...
    var ListItemTitle = (0, import_core31.styled)(ListItemText, {
      name: "ListItemTitle"
    });
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_core31.useMediaPropsActive)(props);
      ...
      const spaceSize = (0, import_core31.getVariableValue)((0, import_core31.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_stacks9.YStack, { flex: 1, children: [
              ...
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Spacer, { flex: true, size: spaceSize * 0.333 }),
    ...
    var ListItem = (0, import_core31.withStaticProperties)(
      ListItemFrame.extractable(
        (0, import_core31.themeable)(ListItemComponent, { componentName: NAME3 }),
      ...
      return {
        ...
        async fn(middlewareArguments) {
          ...
          const {
            main,
            cross
          } = getAlignmentSides(currentPlacement, rects, await (platform3.isRTL == null ? void 0 : platform3.isRTL(elements.floating)));
    ...
    inline = /* @__PURE__ */ __name(function(options) {
      ...
      return {
        ...
        async fn(middlewareArguments) {
          ...
          const fallback = rectToClientRect(platform3.convertOffsetParentRelativeRectToViewportRelativeRect ? await platform3.convertOffsetParentRelativeRectToViewportRelativeRect({
            rect: rects.reference,
            offsetParent: await (platform3.getOffsetParent == null ? void 0 : platform3.getOffsetParent(elements.floating)),
            strategy
          }) : rects.reference);
          const clientRects = await (platform3.getClientRects == null ? void 0 : platform3.getClientRects(elements.reference)) || [];
          const paddingObject = getSideObjectFromPadding(padding);
          ...
          __name(getBoundingClientRect3, "getBoundingClientRect");
          const resetRects = await platform3.getElementRects({
            reference: {
...
function getUAString2() {
  ...
  const uaData = navigator.userAgentData;
  if (uaData && Array.isArray(uaData.brands)) {
    uaString2 = uaData.brands.map((item) => item.brand + "/" + item.version).join(" ");
    return uaString2;
  }
  return navigator.userAgent;
}
function isHTMLElement3(value) {
  return value instanceof getWindow3(value).HTMLElement;
}
function isElement3(value) {
  return value instanceof getWindow3(value).Element;
}
function isNode2(value) {
  return value instanceof getWindow3(value).Node;
}
function isShadowRoot2(node) {
  if (typeof ShadowRoot === "undefined") {
    return false;
  }
  const OwnElement = getWindow3(node).ShadowRoot;
  return node instanceof OwnElement || node instanceof ShadowRoot;
}
...
function isContainingBlock2(element) {
  ...
  const css = getComputedStyle$12(element);
  const backdropFilter = css.backdropFilter || css.WebkitBackdropFilter;
...
function getBoundingClientRect2(element, includeScale, isFixedStrategy, offsetParent) {
  ...
  const win = domElement ? getWindow3(domElement) : window;
  ...
  let height = clientRect.height / scale.y;
  if (domElement) {
    const win2 = getWindow3(domElement);
...
function getRectRelativeToOffsetParent2(element, offsetParent, strategy) {
  ...
  const rect = getBoundingClientRect2(element, true, strategy === "fixed", offsetParent);
  let scroll = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function getParentNode2(node) {
  ...
  const result = (
    ...
    node.assignedSlot || // DOM Element detected
    node.parentNode || // ShadowRoot detected
    (isShadowRoot2(node) ? node.host : null) || // Fallback
    getDocumentElement2(node)
  );
  return isShadowRoot2(result) ? result.host : result;
}
function getTrueOffsetParent2(element) {
  if (!isHTMLElement3(element) || getComputedStyle$12(element).position === "fixed") {
    return null;
  }
  return element.offsetParent;
}
function getContainingBlock2(element) {
  ...
  while (isHTMLElement3(currentNode) && !isLastTraversableNode2(currentNode)) {
...
function getOffsetParent2(element) {
  ...
  if (offsetParent && (getNodeName2(offsetParent) === "html" || getNodeName2(offsetParent) === "body" && getComputedStyle$12(offsetParent).position === "static" && !isContainingBlock2(offsetParent))) {
    return window2;
  }
...
function getInnerBoundingClientRect2(element, strategy) {
  ...
  const top = clientRect.top + element.clientTop;
  const left = clientRect.left + element.clientLeft;
  const scale = isHTMLElement3(element) ? getScale2(element) : {
    x: 1,
    y: 1
  };
  const width = element.clientWidth * scale.x;
...
function getClientRectFromClippingAncestor2(element, clippingAncestor, strategy) {
  if (clippingAncestor === "viewport") {
    return rectToClientRect(getViewportRect2(element, strategy));
  }
  if (isElement3(clippingAncestor)) {
    return getInnerBoundingClientRect2(clippingAncestor, strategy);
  }
  return rectToClientRect(getDocumentRect2(getDocumentElement2(element)));
}
function getClippingElementAncestors2(element, cache) {
  ...
  let result = getOverflowAncestors2(element).filter((el) => isElement3(el) && getNodeName2(el) !== "body");
  let currentContainingBlockComputedStyle = null;
  const elementIsFixed = getComputedStyle$12(element).position === "fixed";
  ...
  while (isElement3(currentNode) && !isLastTraversableNode2(currentNode)) {
    const computedStyle = getComputedStyle$12(currentNode);
    const containingBlock = isContainingBlock2(currentNode);
    const shouldDropCurrentNode = elementIsFixed ? !containingBlock && !currentContainingBlockComputedStyle : !containingBlock && computedStyle.position === "static" && !!currentContainingBlockComputedStyle && ["absolute", "fixed"].includes(currentContainingBlockComputedStyle.position);
    if (shouldDropCurrentNode) {
      result = result.filter((ancestor) => ancestor !== currentNode);
    } else {
...
function autoUpdate2(reference, floating, update, options) {
  ...
  const ancestorScroll = _ancestorScroll && !animationFrame;
  const ancestors = ancestorScroll || ancestorResize ? [...isElement3(reference) ? getOverflowAncestors2(reference) : reference.contextElement ? getOverflowAncestors2(reference.contextElement) : [], ...getOverflowAncestors2(floating)] : [];
  ancestors.forEach((ancestor) => {
    ancestorScroll && ancestor.addEventListener("scroll", update, {
      passive: true
    });
...
var uaString2, min3, max3, round2, FALLBACK_SCALE2, platform2, computePosition3;
var init_floating_ui_dom2 = __esm({
  "node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs"() {
    init_floating_ui_core();
    init_floating_ui_core();
    __name(getWindow3, "getWindow");
    __name(getComputedStyle$12, "getComputedStyle$1");
    __name(getNodeName2, "getNodeName");
    __name(getUAString2, "getUAString");
    __name(isHTMLElement3, "isHTMLElement");
    __name(isElement3, "isElement");
    __name(isNode2, "isNode");
    __name(isShadowRoot2, "isShadowRoot");
    __name(isOverflowElement2, "isOverflowElement");
    __name(isTableElement2, "isTableElement");
    __name(isContainingBlock2, "isContainingBlock");
    __name(isLayoutViewport, "isLayoutViewport");
    __name(isLastTraversableNode2, "isLastTraversableNode");
    min3 = Math.min;
    max3 = Math.max;
    round2 = Math.round;
    __name(getCssDimensions2, "getCssDimensions");
    ...
    __name(getRectRelativeToOffsetParent2, "getRectRelativeToOffsetParent");
    ...
    __name(getDimensions2, "getDimensions");
    __name(convertOffsetParentRelativeRectToViewportRelativeRect2, "convertOffsetParentRelativeRectToViewportRelativeRect");
    __name(getViewportRect2, "getViewportRect");
    __name(getDocumentRect2, "getDocumentRect");
    __name(getNearestOverflowAncestor2, "getNearestOverflowAncestor");
    __name(getOverflowAncestors2, "getOverflowAncestors");
    __name(getInnerBoundingClientRect2, "getInnerBoundingClientRect");
    __name(getClientRectFromClippingAncestor2, "getClientRectFromClippingAncestor");
    __name(getClippingElementAncestors2, "getClippingElementAncestors");
    ...
    platform2 = {
      ...
      getClientRects: (element) => Array.from(element.getClientRects()),
      isRTL: (element) => getComputedStyle$12(element).direction === "rtl"
    };
    __name(autoUpdate2, "autoUpdate");
    computePosition3 = /* @__PURE__ */ __name((reference, floating, options) => {
      const cache = /* @__PURE__ */ new Map();
      const mergedOptions = {
        platform: platform2,
        ...options
...
__export(floating_ui_react_dom_esm_exports, {
  ...
  detectOverflow: () => detectOverflow,
  flip: () => flip,
  getOverflowAncestors: () => getOverflowAncestors2,
  hide: () => hide,
  inline: () => inline,
  limitShift: () => limitShift,
  offset: () => offset,
...
function useFloating4(_temp) {
  ...
  const update = React10.useCallback(() => {
    ...
    computePosition3(reference.current, floating.current, {
      middleware: latestMiddleware,
      placement,
      strategy
    }).then((data2) => {
...
var require_Popper = __commonJS({
  "node_modules/@tamagui/popper/dist/cjs/Popper.js"(exports, module2) {
    ...
    var PopperContentFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: "PopperContent",
      backgroundColor: "$background",
      alignItems: "center",
      radiused: true,
    ...
    var PopperArrowFrame = (0, import_core31.styled)(import_stacks9.YStack, {
      name: "PopperArrow",
      borderColor: "$borderColor",
      backgroundColor: "$background",
      position: "relative"
    });
    var PopperArrowOuterFrame = (0, import_core31.styled)(import_stacks9.YStack, {
    ...
    var PopperArrow = PopperArrowFrame.extractable(
      React14.forwardRef(/* @__PURE__ */ __name(function PopperArrow2(props, forwardedRef) {
        ...
        const sizeValResolved = (0, import_core31.getVariableValue)((0, import_get_size2.stepTokenUpOrDown)("space", sizeVal, -2, [2]));
...
var require_Popover = __commonJS({
  "node_modules/@tamagui/popover/dist/cjs/Popover.js"(exports, module2) {
    ...
    function PopoverContentPortal(props) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_portal3.Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_core31.Theme, { forceClassName: true, name: themeName, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Stack, { zIndex: zIndex + 1, children: contents })
      ] }) });
    }
            ...
            import_remove_scroll2.RemoveScroll,
            {
              ...
              children: trapFocus === false ? children : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                import_focus_scope2.FocusScope,
                {
                  ...
                  onMountAutoFocus: onOpenAutoFocus,
                  onUnmountAutoFocus: onCloseAutoFocus,
                  children: import_core31.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "contents" }, children }) : children
                }
              )
            }
          )
    ...
    var Popover = (0, import_core31.withStaticProperties)(
      (props) => {
        const {
          __scopePopover,
          children,
        ...
        const internalId = (0, import_core31.useId)();
        ...
        const popoverContext = {
          ...
          sheetBreakpoint,
          contentId: (0, import_core31.useId)(),
          triggerRef,
          open,
          breakpointActive,
          onOpenChange: setOpen,
          onOpenToggle: (0, import_core31.useEvent)(() => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AdaptProvider, { children: import_core31.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_floating.FloatingOverrideContext.Provider, { value: useFloatingContext, children: contents }) : contents });
      },
      {
...
var require_Progress = __commonJS({
  "node_modules/@tamagui/progress/dist/cjs/Progress.js"(exports, module2) {
    ...
    var ProgressIndicatorFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: INDICATOR_NAME,
      height: "100%",
      width: "100%",
      backgrounded: true
    ...
    function defaultGetValueLabel(value, max4) {
      return `${Math.round(value / max4 * 100)}%`;
    }
    ...
    function isValidMaxNumber(max4) {
      return isNumber(max4) && !isNaN(max4) && max4 > 0;
    }
    __name(isValidMaxNumber, "isValidMaxNumber");
    function isValidValueNumber(value, max4) {
      return isNumber(value) && !isNaN(value) && value <= max4 && value >= 0;
    }
...
Defaulting to \`null\`.`;
    ...
    var DEFAULT_MAX = 100;
    var ProgressFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: PROGRESS_NAME,
      borderRadius: 1e5,
      overflow: "hidden",
      backgrounded: true,
      variants: {
        size: {
          "...size": (val) => {
            const size2 = Math.round((0, import_core31.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.25);
            return {
              height: size2,
              minWidth: (0, import_core31.getVariableValue)(size2) * 20,
              width: "100%"
            };
          }
        }
    ...
    var Progress = (0, import_core31.withStaticProperties)(
      ProgressFrame.extractable(
        React14.forwardRef(
          (props, forwardedRef) => {
            ...
            const max4 = isValidMaxNumber(maxProp) ? maxProp : DEFAULT_MAX;
            const value = isValidValueNumber(valueProp, max4) ? valueProp : null;
            const valueLabel = isNumber(value) ? getValueLabel(value, max4) : void 0;
            const [width, setWidth] = React14.useState(0);
            return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max4, width, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              ProgressFrame,
              {
                size: size2,
                "aria-valuemax": max4,
                ...
                role: "progressbar",
                "data-state": getProgressState(value, max4),
    ...
    Progress.propTypes = {
      ...
      value(props, propName, componentName) {
        ...
        const max4 = isValidMaxNumber(props.max) ? props.max : DEFAULT_MAX;
        if (valueProp != null && !isValidValueNumber(valueProp, max4)) {
...
var require_Separator = __commonJS({
  "node_modules/@tamagui/separator/dist/cjs/Separator.js"(exports, module2) {
    ...
    var import_core31 = require("@tamagui/core-node");
    var Separator = (0, import_core31.styled)(import_core31.Stack, {
      name: "Separator",
      borderColor: "$borderColor",
      flexShrink: 0,
      borderWidth: 0,
      ...
      variants: {
        vertical: {
          true: {
            y: 0,
            x: -0.5,
            height: import_core31.isWeb ? "initial" : "auto",
            ...
            maxHeight: import_core31.isWeb ? "initial" : "auto",
            width: 0,
            maxWidth: 0,
            borderBottomWidth: 0,
            borderRightWidth: 1
...
var require_SelectContent = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectContent.js"(exports, module2) {
    ...
    var SelectContent = /* @__PURE__ */ __name(({
      ...
      const contents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Theme, { forceClassName: true, name: themeName, children });
  ...
  "node_modules/@tamagui/select/dist/cjs/SelectViewport.js"(exports, module2) {
    ...
    var SelectViewport = React14.forwardRef(
      (props, forwardedRef) => {
        ...
        if (breakpointActive || !import_core31.isWeb) {
  ...
  "node_modules/@tamagui/select/dist/cjs/Select.js"(exports, module2) {
    ...
    var Select = (0, import_core210.withStaticProperties)(
      (props) => {
        ...
        const SelectImpl = isSheet || !import_core31.isWeb ? SelectSheetImpl : import_SelectImpl.SelectInlineImpl;
...
var require_helpers = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/helpers.js"(exports, module2) {
    ...
    function convertValueToPercentage(value, min4, max4) {
      const maxSteps = max4 - min4;
      const percentPerStep = 100 / maxSteps;
      return percentPerStep * (value - min4);
    }
...
var require_SliderImpl = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/SliderImpl.js"(exports, module2) {
    ...
    var DirectionalYStack2 = (0, import_core31.styled)(import_stacks9.YStack, {
      variants: {
        orientation: {
          horizontal: {},
          vertical: {}
    ...
    var SliderFrame2 = (0, import_core31.styled)(DirectionalYStack2, {
      position: "relative",
      variants: {
        size: (val, extras) => {
          const orientation = extras.props.orientation;
          const size2 = Math.round((0, import_core31.getVariableValue)((0, import_get_size2.getSize)(val)) / 6);
...
var require_Slider = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/Slider.js"(exports, module2) {
    ...
    var SliderHorizontal = React14.forwardRef(
      (props, forwardedRef) => {
        const { min: min4, max: max4, dir, onSlideStart, onSlideMove, onStepKeyDown, ...sliderProps } = props;
        ...
        function getValueFromPointer(pointerPosition) {
          ...
          const output = isDirectionLTR ? [min4, max4] : [max4, min4];
    ...
    var SliderVertical = React14.forwardRef(
      (props, forwardedRef) => {
        const { min: min4, max: max4, onSlideStart, onSlideMove, onStepKeyDown, ...sliderProps } = props;
        const [state, setState] = React14.useState(() => ({ size: 0, offset: 0 }));
        const sliderRef = React14.useRef(null);
        function getValueFromPointer(pointerPosition) {
          const input = [0, state.size];
          const output = [max4, min4];
          const value = (0, import_helpers2.linearScale)(input, output);
          return value(pointerPosition);
        }
        __name(getValueFromPointer, "getValueFromPointer");
    ...
    var SliderTrackFrame = (0, import_core31.styled)(import_SliderImpl.SliderFrame, {
      name: "SliderTrack",
      height: "100%",
      width: "100%",
      backgroundColor: "$background",
    ...
    var SliderTrackActiveFrame = (0, import_core31.styled)(import_SliderImpl.SliderFrame, {
    ...
    var SliderThumbFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: "SliderThumb",
      position: "absolute",
      bordered: 2,
      borderWidth: 2,
    ...
    var Slider = (0, import_core31.withStaticProperties)(
      React14.forwardRef((props, forwardedRef) => {
        const {
          ...
          defaultValue: defaultValue2 = [min4],
          value,
        ...
        function updateValues(value2, atIndex) {
          ...
          const snapToStep = (0, import_helpers2.roundValue)(
            Math.round((value2 - min4) / step) * step + min4,
            decimalCount
          );
          const nextValue = (0, import_helpers.clamp)(snapToStep, [min4, max4]);
          ...
          import_constants.SliderProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              SliderOriented,
              {
                ...
                onHomeKeyDown: () => !disabled && updateValues(min4, 0),
...
var require_Label = __commonJS({
  "node_modules/@tamagui/label/dist/cjs/Label.js"(exports, module2) {
    ...
    var LabelFrame2 = (0, import_core31.styled)(import_text5.SizableText, {
      name: "Label",
      tag: "label",
      size: "$true",
      backgroundColor: "transparent",
    ...
    var LabelComponent2 = React14.forwardRef(
      (props, forwardedRef) => {
        ...
        const ref = React14.useRef(null);
        const composedRefs = (0, import_compose_refs3.useComposedRefs)(forwardedRef, ref);
        const backupId = (0, import_core31.useId)();
    ...
    var Label2 = LabelFrame2.extractable((0, import_core31.themeable)(LabelComponent2), {
      neverFlatten: true
    });
...
var require_Switch = __commonJS({
  "node_modules/@tamagui/switch/dist/cjs/Switch.js"(exports, module2) {
    ...
    var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core31.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.65), "getSwitchHeight");
    ...
    var SwitchThumbFrame = (0, import_core31.styled)(import_stacks9.ThemeableStack, {
      name: "SwitchThumb",
      backgroundColor: "$background",
      borderRadius: 1e3,
      variants: {
        ...
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            SwitchThumbFrame,
            {
              ...
              "data-disabled": disabled ? "" : void 0,
              ...thumbProps,
              x: checked ? (0, import_core31.getVariableValue)(getSwitchWidth(size2)) - (0, import_core31.getVariableValue)(getSwitchHeight(size2)) : 0,
              ref: forwardedRef
            }
          );
        }
    ...
    var SwitchFrame = (0, import_core31.styled)(import_stacks9.XStack, {
      name: "Switch",
      tag: "button",
      borderRadius: 1e3,
      borderWidth: 2,
    ...
    var Switch = (0, import_core31.withStaticProperties)(
      SwitchFrame.extractable(
        React14.forwardRef(
          (props, forwardedRef) => {
            ...
            const isFormControl = import_core31.isWeb ? button ? Boolean(button.closest("form")) : true : false;
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
              SwitchProvider,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                    SwitchFrame,
                    {
                      ...
                      onPress: (event) => {
                        ...
                        if (import_core31.isWeb && isFormControl) {
                  ...
                  import_core31.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                    BubbleInput,
                    {
                      control: button,
...
var require_Tooltip = __commonJS({
  "node_modules/@tamagui/tooltip/dist/cjs/Tooltip.js"(exports, module2) {
    ...
    var Tooltip = (0, import_core31.withStaticProperties)(
      (props) => {
        const {
          __scopePopover,
          children,
        ...
        const onOpenChange = (0, import_core31.useEvent)((open2) => {
          setOpen(open2);
          if (open2) {
            setCurrentId(id);
          }
        ...
        const useFloatingFn = /* @__PURE__ */ __name((props2) => {
          ...
          const { getReferenceProps, getFloatingProps } = (0, import_react_dom_interactions.useInteractions)([
            ...
            (0, import_react_dom_interactions.useFocus)(floating.context, focus2),
  ...
  "node_modules/@tamagui/tooltip/dist/cjs/TooltipSimple.js"(exports, module2) {
    ...
    var TooltipSimple = /* @__PURE__ */ __name(({
      ...
      const contents = /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_Tooltip.Tooltip, { ...tooltipProps, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core31.Theme, { inverse: true, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
...
var require_VisuallyHidden = __commonJS({
  "node_modules/@tamagui/visually-hidden/dist/cjs/VisuallyHidden.js"(exports, module2) {
    ...
    var import_core31 = require("@tamagui/core-node");
    var VisuallyHidden = (0, import_core31.styled)(import_core31.Stack, {
      position: "absolute",
      width: 1,
      height: 1,
      margin: -1,
...
__export(esm_exports, {
  ...
  Fieldset: () => Fieldset,
  FontLanguage: () => import_core30.FontLanguage,
  Footer: () => Footer,
  Form: () => Form,
  Grid: () => Grid,
  ...
  Spacer: () => import_core30.Spacer,
  Spinner: () => Spinner,
  Stack: () => import_core30.Stack,
  TamaguiProvider: () => TamaguiProvider,
  Text: () => import_core30.Text,
  TextAncestorContext: () => import_core30.TextAncestorContext,
  TextArea: () => TextArea,
  TextAreaFrame: () => TextAreaFrame,
  Theme: () => import_core30.Theme,
  ThemeableStack: () => ThemeableStack,
  Unspaced: () => import_core30.Unspaced,
  XGroup: () => XGroup,
  XStack: () => XStack,
  YGroup: () => YGroup,
  YStack: () => YStack,
  ZStack: () => ZStack,
  addTheme: () => import_core30.addTheme,
  buttonStaticConfig: () => buttonStaticConfig,
  composeRefs: () => composeRefs,
  createAvatarScope: () => createAvatarScope,
  createComponent: () => import_core30.createComponent,
  createDialogScope: () => createDialogScope,
  createFont: () => import_core30.createFont,
  createShorthands: () => import_core30.createShorthands,
  createTamagui: () => createTamagui,
  createTheme: () => import_core30.createTheme,
  createTokens: () => import_core30.createTokens,
  createVariable: () => import_core30.createVariable,
  getAnimationDriver: () => import_core30.getAnimationDriver,
  getConfig: () => import_core30.getConfig,
  getElevation: () => getElevation,
  getMedia: () => import_core30.getMedia,
  getSizedElevation: () => getSizedElevation,
  getStylesAtomic: () => import_core30.getStylesAtomic,
  getThemes: () => import_core30.getThemes,
  getTokens: () => import_core30.getTokens,
  getVariable: () => import_core30.getVariable,
  getVariableName: () => import_core30.getVariableName,
  getVariableValue: () => import_core30.getVariableValue,
  idFn: () => idFn,
  insertFont: () => import_core30.insertFont,
  isChrome: () => import_core30.isChrome,
  isClient: () => import_core30.isClient,
  isServer: () => import_core30.isServer,
  isServerSide: () => isServerSide,
  isTamaguiComponent: () => import_core30.isTamaguiComponent,
  isTamaguiElement: () => import_core30.isTamaguiElement,
  isTouchable: () => import_core30.isTouchable,
  isVariable: () => import_core30.isVariable,
  isWeb: () => import_core30.isWeb,
  isWebTouchable: () => import_core30.isWebTouchable,
  matchMedia: () => import_core30.matchMedia,
  mediaObjectToString: () => import_core30.mediaObjectToString,
  mediaQueryConfig: () => import_core30.mediaQueryConfig,
  mediaState: () => import_core30.mediaState,
  spacedChildren: () => import_core30.spacedChildren,
  styled: () => import_core30.styled,
  themeable: () => import_core30.themeable,
  updateTheme: () => import_core30.updateTheme,
  useButton: () => useButton,
  useComposedRefs: () => useComposedRefs,
  useControllableState: () => useControllableState,
  useDidFinishSSR: () => import_core30.useDidFinishSSR,
  useEvent: () => import_core30.useEvent,
  useForceUpdate: () => useForceUpdate,
  useGet: () => import_core30.useGet,
  useIsTouchDevice: () => import_core30.useIsTouchDevice,
  useIsomorphicLayoutEffect: () => import_core30.useIsomorphicLayoutEffect,
  useLabelContext: () => useLabelContext,
  useMedia: () => import_core30.useMedia,
  useSafeRef: () => import_core30.useSafeRef,
  useStyle: () => import_core30.useStyle,
  useTheme: () => import_core30.useTheme,
  useThemeName: () => import_core30.useThemeName,
  variableToString: () => import_core30.variableToString,
  withStaticProperties: () => import_core30.withStaticProperties,
...
__reExport(esm_exports, __toESM(require_cjs35(), 1), module.exports);
...
var TamaguiProvider = import_core18.isRSC ? import_core18.TamaguiProvider : ({ children, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_core18.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_portal2.PortalProvider, { shouldAddRootHost: true, children }) });
};
...
var Form = (0, import_core22.styled)(import_core22.Stack, {
  name: "Form",
  tag: "form"
});
...
var inputSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  if (!import_core24.isWeb && fontStyle) {
...
var textAreaSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  const buttonStyles = (0, import_get_button_sized4.getButtonSized)(val, extras);
  const fontStyle = (0, import_get_font_sized3.getFontSized)(val, extras);
  const height = props.numberOfLines ? (props.numberOfLines || 1) * (0, import_core24.getVariableValue)(fontStyle.lineHeight) : "auto";
...
// node_modules/tamagui/dist/esm/views/Input.js
(0, import_core25.setupReactNative)({
  TextInput: import_react_native3.TextInput
});
var InputFrame = (0, import_core25.styled)(
...
var GroupFrame = (0, import_core26.styled)(ThemeableStack, {
  name: "GroupFrame",
  backgroundColor: "$background",
  y: 0,
  variants: {
...
function createGroup(verticalDefault) {
  return (0, import_react12.forwardRef)((props, ref) => {
    const activeProps = (0, import_core26.useMediaPropsActive)(props);
    const {
      children: childrenProp,
      space,
      size: size2 = "$true",
      ...
      borderRadius,
      ...restProps
    } = (0, import_core26.getExpandedShorthands)(activeProps);
    const radius = borderRadius ?? (size2 ? (0, import_core26.getVariableValue)((0, import_core26.getTokens)().radius[size2]) - 1 : void 0);
    ...
    const children = childrens.map((child, i) => {
      ...
      const props2 = {
        disabled,
        ...(0, import_core26.isTamaguiElement)(child) ? radiusStyles : { style: radiusStyles }
      };
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      GroupFrame,
      {
        ...
        children: wrapScroll(
          activeProps,
          (0, import_core26.spacedChildren)({
            direction: spaceDirection,
            separator,
            space,
            children
...
var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
  const next = (0, import_core26.mergeProps)(child.props, props, false, (0, import_core26.getConfig)().shorthands)[0];
...
var Section = (0, import_core27.styled)(import_core27.Stack, {
  name: "Section",
  tag: "section",
  flexDirection: "column",
  accessibilityRole: "summary"
});
var Article = (0, import_core27.styled)(import_core27.Stack, {
  name: "Article",
  tag: "article",
  flexDirection: "column"
});
var Main = (0, import_core27.styled)(import_core27.Stack, {
  name: "Main",
  tag: "main",
  flexDirection: "column"
});
var Header = (0, import_core27.styled)(import_core27.Stack, {
  name: "Header",
  tag: "header",
  accessibilityRole: "header",
  flexDirection: "column"
});
var Aside = (0, import_core27.styled)(import_core27.Stack, {
  name: "Aside",
  tag: "aside",
  flexDirection: "column"
  // accessibilityRole: 'complementary',
});
var Footer = (0, import_core27.styled)(import_core27.Stack, {
  name: "Footer",
  tag: "footer",
  flexDirection: "column"
  // accessibilityRole: 'contentinfo',
});
var Nav = (0, import_core27.styled)(import_core27.Stack, {
  name: "Nav",
  tag: "nav",
  flexDirection: "column"
...
var Spinner = YStack.extractable(
  (0, import_core28.themeable)(
    React13.forwardRef((props, ref) => {
      const { size: size2, color: colorProp, ...stackProps } = props;
      const theme = (0, import_core28.useTheme)();
      let color = colorProp;
      if (color && color[0] === "$") {
        color = (0, import_core28.variableToString)(theme[color]);
      }
...
var TextAreaFrame = (0, import_core29.styled)(InputFrame, {
  name: "TextArea",
  multiline: true,
  numberOfLines: 4,
  height: "auto",
